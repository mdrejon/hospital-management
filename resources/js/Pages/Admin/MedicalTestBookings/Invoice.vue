        ...
        <div class="invoice">
            ...
            <div class="header">
                ...
                <div class="invoice-details">
                    <h2>INVOICE / TOKEN</h2>
                    <p><strong>Order #:</strong> {{ booking.booking_number }}</p>
            ...
            <div class="info-section">
                <div class="patient-info">
                    ...
                    <p><strong>Gender/Age:</strong> <span class="capitalize">{{ booking.gender }}</span> {{ booking.date_of_birth ? `(${booking.date_of_birth})` : '' }}</p>
                    <p><strong>Address:</strong> {{ booking.address || 'N/A' }}</p>
                </div>
                <div class="doctor-info">
                    <h3>Referral Details</h3>
                    <p v-if="booking.doctor">
                        <strong>Doctor:</strong> Dr. {{ displayTranslatable(booking.doctor.name, langs) }}
                    </p>
                    <p v-else>
                        <strong>Doctor:</strong> Direct Patient
                    </p>
            ...
            <table class="items-table">
                ...
                <tbody>
                    <tr v-for="item in booking.items" :key="item.id">
                        ...
                        <td class="text-center">{{ item.medical_test?.sample_type || 'Blood' }}</td>
                        <td class="text-right">{{ Number(item.final_price).toLocaleString() }}</td>
                    </tr>
                </tbody>
            </table>
            ...
            <div class="totals-section">
                ...
                <div class="totals">
                    <div class="total-row">
                        <span>Subtotal:</span>
                        <span>BDT {{ Number(booking.subtotal_amount).toLocaleString() }}</span>
                    </div>
                    <div class="total-row discount" v-if="booking.discount_amount > 0">
                        <span>Discount:</span>
                        <span>- BDT {{ Number(booking.discount_amount).toLocaleString() }}</span>
                    </div>
                    ...
                    <div class="total-row paid">
                        ...
                        <span>BDT {{ Number(booking.paid_amount).toLocaleString() }}</span>
                    </div>
