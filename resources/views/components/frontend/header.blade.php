      ...
      <div class="top-header__inner">
        <div class="top-header__left">
          ...
          <span class="top-header__item">
            ...
            <span class="top-header__value">Call : <a href="tel:{{ $headerSettings['header_phone'] ?? '+1 (234) 5688 9990' }}" style="color: #2563eb; text-decoration: none;">{{ $headerSettings['header_phone'] ?? '+1 (234) 5688 9990' }}</a></span>
          </span>
        ...
        <div class="top-header__right">
          ...
          <div class="top-header__socials">
            ...
            <a href="{{ $headerSettings['header_twitter_url'] ?? '#' }}" class="top-header__social-link" aria-label="Twitter">
              <svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor">
            ...
            <a href="{{ $headerSettings['header_linkedin_url'] ?? '#' }}" class="top-header__social-link" aria-label="LinkedIn">
              <svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor">
  ...
  <div class="site-header__nav">
    <div class="site-header__inner">
      ...
      <nav class="main-nav">
        ...
        <a href="{{ route('packages') }}" class="main-nav__link {{ request()->routeIs('packages') ? 'is-active' : '' }}">Packages</a>
