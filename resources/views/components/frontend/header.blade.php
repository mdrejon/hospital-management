    ...
    <div class="top-info-bar">
      <div class="top-info-bar__inner">
        <span class="top-info-bar__item">
            ...
            <img src="{{ asset('assets/img/logo.png') }}" alt="Sitakund Modern Hospital Ltd." height="60" style="height:60px;width:auto" />
          </a>
        </span>
  ...
  <div class="site-header__nav">
    <div class="site-header__inner">
      ...
      <a href="{{ route('home') }}" class="site-logo site-logo--mobile">
        <img src="{{ asset('assets/img/logo.png') }}" alt="Sitakund Modern Hospital Ltd." height="42" style="height:42px;width:auto" />
      </a>
      ...
      <div class="site-header__actions">
        <a href="{{ route('appointment') }}" class="btn-appointment">Appointment</a>
  ...
  <aside class="side-panel" data-side-panel>
    ...
    <a href="{{ route('home') }}" class="site-logo">
      <img src="{{ asset('assets/img/logo.png') }}" alt="Sitakund Modern Hospital Ltd." height="56" style="height:56px;width:auto" />
    </a>
