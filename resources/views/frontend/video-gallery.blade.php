...
@section('content')
    ...
    <section class="page-header">
      <div class="page-header__media">
        <img src="{{ $heroImage }}" alt="Hospital Video Gallery" class="page-header__bg" />
      ...
      <div class="container mx-auto">
        <div class="team__head">
          <p class="team__eyebrow">
            ...
            {{ $pageSettings['video_gallery_badge'] ?? 'Our Video Gallery' }}
            <span class="team__eyebrow-dot"></span>
          </p>
          <h2 class="team__title">{{ $pageSettings['video_gallery_title'] ?? 'Explore Our Healthcare Stories' }}</h2>
        </div>
        ...
        <div class="video-gallery__grid">
          @foreach($videoItems as $item)
            ...
            <article class="video-card group">
              ...
              <div class="video-card__media js-video-trigger" data-embed="{{ $embedUrl }}" data-type="{{ $item->video_type }}" data-title="{{ $vTitle }}">
                <img src="{{ $thumb }}" alt="{{ $vTitle }}" class="video-card__img" />
                <span class="video-card__overlay"></span>
                
                <!-- Animated Play Button -->
                <button type="button" class="video-card__play" aria-label="Play {{ $vTitle }}">
                  <svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor"><path d="M8 5v14l11-7z"/></svg>
                </button>

                <!-- Video Type Badge -->
                <span class="video-card__badge-type">
                  {{ strtoupper($item->video_type ?? 'VIDEO') }}
                </span>
              ...
              <div class="video-card__body">
                <div>
                  ...
                  <h3 class="video-card__title">
                    <a href="javascript:void(0)" class="js-video-trigger" data-embed="{{ $embedUrl }}" data-type="{{ $item->video_type }}" data-title="{{ $vTitle }}">
                      {{ $vTitle }}
                    </a>
                  </h3>
                ...
                <div class="video-card__footer">
                  <button type="button" class="video-card__btn js-video-trigger" data-embed="{{ $embedUrl }}" data-type="{{ $item->video_type }}" data-title="{{ $vTitle }}">
