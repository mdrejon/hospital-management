...
@if(!empty($appt['appt_seo_keywords']))
@section('meta_keywords', $appt['appt_seo_keywords'])
@endif
@if(!empty($appt['appt_seo_og_image']))
@section('og_image', asset('storage/' . $appt['appt_seo_og_image']))
@endif
