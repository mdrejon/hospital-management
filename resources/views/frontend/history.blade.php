...
@section('title', 'Our History | ClinicMaster Medical & Health Care Services')
        ...
        <div class="history__timeline">
          ...
          <article class="history-item">
            <div class="history-item__media">
              <img src="{{ asset('assets/img/slider-1.2.jpg') }}" alt="ClinicMaster hospital building at its grand opening" class="history-item__img" />
            </div>
          ...
          <article class="history-item history-item--reverse">
            <div class="history-item__media">
              <img src="{{ asset('assets/img/sr-1-1.jpg') }}" alt="Radiologist reviewing scans in the diagnostic imaging center" class="history-item__img" />
            </div>
            <div class="history-item__node">
          ...
          <article class="history-item">
            <div class="history-item__media">
              <img src="{{ asset('assets/img/sr-1-3.jpg') }}" alt="Critical care team working in the intensive care unit" class="history-item__img" />
            </div>
            <div class="history-item__node">
          ...
          <article class="history-item history-item--reverse">
            <div class="history-item__media">
              <img src="{{ asset('assets/img/projects-3.jpg') }}" alt="Doctor holding a video consultation with a patient" class="history-item__img" />
            </div>
            <div class="history-item__node">
          ...
          <article class="history-item">
            <div class="history-item__media">
              <img src="{{ asset('assets/img/slider-1.3.jpg') }}" alt="ClinicMaster medical team celebrating national accreditation" class="history-item__img" />
            </div>
            <div class="history-item__node">
