...
@section('content')
    ...
    <section class="departments">
      ...
      <div class="departments__banner">
        <img src="{{ asset('assets/img/slider-1.3.jpg') }}" alt="" class="departments__banner-bg" />
      ...
      <div class="container relative mx-auto">
        <div class="faq__grid">
          <div class="faq__copy">
            ...
            @endphp
            <h2 class="faq__title">{{ $homeFaqTitle }}</h2>
            <p class="faq__desc">
              {{ $homeFaqDesc }}
            </p>
          ...
          <div class="faq__media">
            <img src="{{ $homeFaq['image'] ?: asset('assets/img/faq.webp') }}" alt="{{ $homeFaq['image_alt'] ?: 'Smiling doctor on a call, ready to answer your questions' }}" class="faq__photo" />
