...
<body class="font-sans">
  ...
  @if(($footerSettings['footer_lets_talk_enabled'] ?? '0') === '1' && !empty($footerSettings['footer_lets_talk_phone']))
  <a href="tel:{{ preg_replace('/[^0-9+]/', '', $footerSettings['footer_lets_talk_phone']) }}" class="floating-btn floating-btn--talk" aria-label="Let's Talk">
  ...
  @if(($footerSettings['footer_whatsapp_enabled'] ?? '0') === '1' && !empty($footerSettings['footer_whatsapp_number']))
  <a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', $footerSettings['footer_whatsapp_number']) }}" target="_blank" rel="noopener noreferrer" class="floating-btn floating-btn--whatsapp" aria-label="WhatsApp">
