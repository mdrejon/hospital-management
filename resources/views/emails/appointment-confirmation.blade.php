...
<div class="wrapper">
  ...
  <div class="body">
    <p class="greeting">Dear <strong>{{ $appointment->name }}</strong>,</p>
    <p class="intro">
      Thank you for booking an appointment with {{ config('app.name') }}. Here are your details:
    </p>

    <div class="msg-box">
      <div class="row"><span>Serial Number</span><span><strong>#{{ $appointment->serial_number }}</strong></span></div>
      ...
      @if($appointment->fee)
      <div class="row"><span>Consultation Fee</span><span>{{ number_format($appointment->fee, 2) }}</span></div>
      @endif
    </div>
