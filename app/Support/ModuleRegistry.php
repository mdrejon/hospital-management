...
class ModuleRegistry
{
    ...
    public static function all(): array
    {
        return [
            ...
            ['key' => 'medical-tests',       'name' => 'Medical Tests',       'actions' => ['view', 'create', 'edit', 'delete']],
            ['key' => 'agents',              'name' => 'Agents Management',   'actions' => ['view', 'create', 'edit', 'delete']],
    ...
    public static function resolveModule(string $routeName): ?string
    {
        $map = [
            ...
            'admin.medical-tests'           => 'medical-tests',
            'admin.medical-test-categories' => 'medical-tests',
            'admin.medical-test-bookings'   => 'medical-tests',

            'admin.agents'                  => 'agents',
            'admin.withdrawals'             => 'agents',
            ...
            'admin.website-settings.video-gallery' => 'website-management',
            ...
            'admin.website-settings.sms'      => 'global-settings',
