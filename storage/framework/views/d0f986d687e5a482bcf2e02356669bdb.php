...
<?php if(!empty($page->seo_keywords)): ?>
<?php $__env->startSection('meta_keywords', $page->seo_keywords); ?>
<?php endif; ?>
<?php if(!empty($page->seo_og_image)): ?>
<?php $__env->startSection('og_image', asset('storage/' . $page->seo_og_image)); ?>
<?php endif; ?>
    ...
    <section class="page-header">
      ...
      <div class="page-header__inner">
        ...
        <nav class="page-header__breadcrumb" aria-label="Breadcrumb">
          ...
          <?php $__currentLoopData = $trail; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $crumb): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          ...
          <?php if($loop->last): ?>
            <span><?php echo e($crumb->breadcrumb_title ?: $crumb->title); ?></span>
          <?php else: ?>
            <a href="<?php echo e(url($crumb->fullPath())); ?>"><?php echo e($crumb->breadcrumb_title ?: $crumb->title); ?></a>
          <?php endif; ?>
...
<?php echo $__env->make('layouts.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon-new\laragon\www\hospital-management\resources\views\frontend\page.blade.php ENDPATH**/ ?>