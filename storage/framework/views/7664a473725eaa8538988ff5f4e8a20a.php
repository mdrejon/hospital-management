...
<?php $__env->startSection('content'); ?>
    ...
    <section class="page-header">
      ...
      <div class="page-header__inner">
        <h1 class="page-header__title"><?php echo e($docName); ?></h1>
    ...
    <section class="doctor-detail">
      <div class="container mx-auto">
        <div class="doctor-detail__grid">
          ...
          <!-- Content -->
          <div>
            <h2 class="doctor-detail__name"><?php echo e($docName); ?></h2>
            ...
            <div class="doctor-info-table">
              <?php $__currentLoopData = $docInfoRows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $info): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <div class="doctor-info-table__row">
                <span class="doctor-info-table__label"><?php echo e($info['label']); ?></span>
                <div class="doctor-info-table__values">
                  <?php $__currentLoopData = $info['values']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <span class="doctor-info-table__value"><?php echo e($value); ?></span>
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
              </div>
              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.frontend.book-appointment','data' => ['settings' => $appt,'doctors' => $appointmentDoctors,'preselectedDoctor' => $doctor,'source' => 'doctor_details_page']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
