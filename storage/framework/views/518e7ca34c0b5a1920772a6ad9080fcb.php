<?php $__env->startSection('title', 'Privacy Policy | ClinicMaster Medical & Health Care Services'); ?>
      ...
      <div class="container mx-auto">
        <div class="legal__inner">
          ...
          <p class="legal__intro">
            ClinicMaster ("we", "us", or "our") is committed to protecting the privacy of our patients and website
            visitors. This Privacy Policy explains what information we collect, how we use it, and the choices you
            have regarding your data.
          </p>

          <div class="legal__section">
            <h2 class="legal__heading">Information We Collect</h2>
            <p class="legal__text">
              We may collect personal information you provide directly, such as your name, contact details, date
              of birth, and medical history when you book an appointment, fill out a contact form, or subscribe to
              our newsletter.
            </p>
          ...
          <div class="legal__section">
            <h2 class="legal__heading">How We Use Your Information</h2>
            <p class="legal__text">
              We use the information we collect to schedule and confirm appointments, provide medical care, respond
              to inquiries, send appointment reminders, and improve our services. We do not sell your personal
              information to third parties.
            </p>
          </div>

          <div class="legal__section">
            <h2 class="legal__heading">Data Security</h2>
            <p class="legal__text">
              We use administrative, technical, and physical safeguards designed to protect your personal and
              health information against unauthorized access, alteration, or disclosure.
            </p>
          </div>

          <div class="legal__section">
            <h2 class="legal__heading">Your Rights</h2>
            <p class="legal__text">
              You may request access to, correction of, or deletion of your personal information at any time by
              contacting us at support@hospital.com or 1 123 456 7890.
            </p>
          </div>

          <div class="legal__section">
            <h2 class="legal__heading">Changes to This Policy</h2>
            <p class="legal__text">
...
<?php echo $__env->make('layouts.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon-new\laragon\www\hospital-management\resources\views\frontend\privacy-policy.blade.php ENDPATH**/ ?>