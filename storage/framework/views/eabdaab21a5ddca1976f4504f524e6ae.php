<?php $__env->startSection('title', 'Our Doctors | ClinicMaster Medical & Health Care Services'); ?>
    ...
    <section class="doctors-page">
      <div class="container mx-auto">
        <div class="team__head">
          ...
          <h2 class="team__title">Meet Our Doctor <span class="accent">Meeting</span></h2>
        </div>
