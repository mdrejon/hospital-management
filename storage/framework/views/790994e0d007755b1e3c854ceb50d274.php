<?php $__env->startSection('title', 'Terms & Conditions | ClinicMaster Medical & Health Care Services'); ?>
    ...
    <section class="legal">
      <div class="container mx-auto">
        <div class="legal__inner">
          <p class="legal__updated">Last updated: July 6, 2026</p>
          <p class="legal__intro">
            These Terms &amp; Conditions govern your use of the ClinicMaster website and the healthcare services
            booked through it. By using our website or booking an appointment, you agree to these terms.
          </p>

          <div class="legal__section">
            <h2 class="legal__heading">Appointments &amp; Cancellations</h2>
            <p class="legal__text">
              Appointments booked online or by phone are subject to confirmation by our staff. You may reschedule
              or cancel an appointment free of charge up to 24 hours before your scheduled visit. Late cancellations
              or no-shows may be subject to a fee.
            </p>
          </div>

          <div class="legal__section">
            <h2 class="legal__heading">Medical Disclaimer</h2>
            <p class="legal__text">
              Content on this website is provided for general informational purposes only and does not constitute
              medical advice. Always consult a qualified healthcare professional for diagnosis and treatment of any
              medical condition.
            </p>
          </div>

          <div class="legal__section">
            <h2 class="legal__heading">Billing &amp; Payments</h2>
            <p class="legal__text">
              Fees for services are due at the time of treatment unless other arrangements have been made with our
              billing department. We accept most major insurance plans; please confirm your coverage before your
              visit.
            </p>
          </div>

          <div class="legal__section">
            <h2 class="legal__heading">Website Use</h2>
            <p class="legal__text">
              You agree not to misuse this website, attempt unauthorized access to our systems, or submit false
              information when booking an appointment or contacting our team.
            </p>
          </div>

          <div class="legal__section">
            <h2 class="legal__heading">Limitation of Liability</h2>
            <p class="legal__text">
              ClinicMaster is not liable for any indirect or consequential damages arising from your use of this
              website. Nothing in these terms limits our liability for matters that cannot be excluded under
              applicable law.
            </p>
          </div>

          <div class="legal__section">
            <h2 class="legal__heading">Contact</h2>
            <p class="legal__text">
              Questions about these Terms &amp; Conditions can be sent to support@hospital.com or 1 123 456 7890.
            </p>
          </div>
        </div>
      </div>
...
<?php echo $__env->make('layouts.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon-new\laragon\www\hospital-management\resources\views/frontend/terms-conditions.blade.php ENDPATH**/ ?>