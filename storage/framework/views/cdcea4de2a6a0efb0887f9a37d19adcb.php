  ...
  <div class="container relative mx-auto">
    ...
    <div class="book-appointment__card">
      <div class="book-appointment__form-col">
        ...
        <p class="book-appointment__alert book-appointment__alert--success"><?php echo e(session('success')); ?></p>
        <?php endif; ?>
        <?php if($errors->any()): ?>
        <p class="book-appointment__alert book-appointment__alert--error"><?php echo e($errors->first()); ?></p>
        <?php endif; ?>
        ...
        <form class="book-appointment__form" action="<?php echo e(route('appointment.submit')); ?>" method="POST" enctype="multipart/form-data" data-booking-form>
          ...
          <?php if($paymentSettings['has_online']): ?>
          <div class="book-appointment__gateway-group" data-gateway-selector style="<?php echo e(!$paymentSettings['allow_without_pay'] ? 'display:grid;' : 'display:none;'); ?> grid-column: span 2; grid-template-columns: repeat(auto-fit, minmax(180px, 1fr)); gap: 10px; margin-top: 4px; margin-bottom: 8px;">
