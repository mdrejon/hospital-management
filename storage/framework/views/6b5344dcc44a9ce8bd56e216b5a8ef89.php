...
<div class="wrapper">
  ...
  <div class="body">
    ...
    ?>
    <span class="<?php echo e($badgeClass); ?>"><?php echo e($inquiry->typeLabel()); ?></span>

    <table class="info-table">
      <tr><td class="key">Name</td><td class="val"><?php echo e($inquiry->name); ?></td></tr>
      <tr><td class="key">Email</td><td class="val"><?php echo e($inquiry->email); ?></td></tr>
      <?php if($inquiry->phone): ?>
      <tr><td class="key">Phone</td><td class="val"><?php echo e($inquiry->phone); ?></td></tr>
      <?php endif; ?>
      <?php if($inquiry->subject): ?>
      <tr><td class="key">Subject</td><td class="val"><?php echo e($inquiry->subject); ?></td></tr>
      <?php endif; ?>
      <tr><td class="key">Submitted</td><td class="val"><?php echo e($inquiry->created_at->format('d M Y, h:i A')); ?></td></tr>
    </table>
    ...
    <div class="msg-box"><?php echo e($inquiry->message); ?></div>

    <a href="<?php echo e(route('admin.inquiries.show', $inquiry->id)); ?>" class="action-btn">
...
<?php /**PATH D:\laragon-new\laragon\www\hospital-management\resources\views\emails\inquiry-notification.blade.php ENDPATH**/ ?>