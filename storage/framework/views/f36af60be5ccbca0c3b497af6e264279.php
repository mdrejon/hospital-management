<?php $__env->startSection('title', ($query !== '' ? 'Search results for "' . $query . '"' : 'Search') . ' | ' . config('app.name')); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <section class="page-header">
      ...
      <div class="page-header__inner">
        <h1 class="page-header__title"><?php echo e(__('frontend.breadcrumb.search_results')); ?></h1>
        <nav class="page-header__breadcrumb" aria-label="Breadcrumb">
          ...
          <span><?php echo e(__('frontend.breadcrumb.search')); ?></span>
        </nav>
      </div>
    ...
    <section class="services">
      <div class="container mx-auto">
        <div class="services__head">
          <p class="services__eyebrow"><?php echo e($results->count()); ?> result<?php echo e($results->count() === 1 ? '' : 's'); ?> found</p>
          <h2 class="services__title">
            <?php if($query !== ''): ?>
              Search results for &ldquo;<?php echo e($query); ?>&rdquo;
            <?php else: ?>
        ...
        <?php elseif($results->isEmpty()): ?>
          <p class="mt-6 text-center text-slate-500">No results found for &ldquo;<?php echo e($query); ?>&rdquo;. Try a different keyword.</p>
        <?php else: ?>
        <div class="services__grid">
          <?php $__currentLoopData = $results; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $card): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <article class="service-card">
            <div class="service-card__media">
              <img src="<?php echo e($card['image']); ?>" alt="<?php echo e($card['title']); ?>" class="service-card__img" />
              <span class="service-card__icon">
                <?php echo $card['icon_svg'] ?: '<svg width="26" height="26" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M9 4a3 3 0 0 0-3 3 3 3 0 0 0-1 5.8A3 3 0 0 0 8 17a3 3 0 0 0 3-3V7a3 3 0 0 0-2-3z" stroke="currentColor" stroke-width="1.5" stroke-linejoin="round"/><path d="M15 4a3 3 0 0 1 3 3 3 3 0 0 1 1 5.8A3 3 0 0 1 16 17a3 3 0 0 1-3-3V7a3 3 0 0 1 2-3z" stroke="currentColor" stroke-width="1.5" stroke-linejoin="round"/></svg>'; ?>

              </span>
            </div>
            <div class="service-card__body">
              <p class="service-card__desc" style="font-weight:700; margin-bottom: 0.25rem;"><?php echo e($card['type']); ?></p>
...
<?php echo $__env->make('layouts.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon-new\laragon\www\hospital-management\resources\views/frontend/search.blade.php ENDPATH**/ ?>