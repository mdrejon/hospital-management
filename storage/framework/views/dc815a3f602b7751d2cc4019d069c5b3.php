<?php $__env->startSection('title', 'Gallery | ClinicMaster Medical & Health Care Services'); ?>
      ...
      <div class="container mx-auto">
        ...
        <div class="gallery__grid">
          <a href="#" class="gallery-item" data-gallery-item>
            <img src="<?php echo e(asset('assets/img/slider-1.2.jpg')); ?>" alt="ClinicMaster treatment room" class="gallery-item__img aspect-[4/3]" />
          ...
          <a href="#" class="gallery-item" data-gallery-item>
            <img src="<?php echo e(asset('assets/img/sr-1-1.jpg')); ?>" alt="Radiology and imaging department" class="gallery-item__img aspect-[3/4]" />
            <span class="gallery-item__overlay">
              <span class="gallery-item__expand">
                <svg width="30" height="30" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M15 4h5v5M9 20H4v-5M20 4l-6 6M4 20l6-6" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
          ...
          <a href="#" class="gallery-item" data-gallery-item>
            <img src="<?php echo e(asset('assets/img/projects-2.jpg')); ?>" alt="Doctors reviewing patient charts" class="gallery-item__img aspect-square" />
            <span class="gallery-item__overlay">
              <span class="gallery-item__expand">
                <svg width="30" height="30" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M15 4h5v5M9 20H4v-5M20 4l-6 6M4 20l6-6" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
          ...
          <a href="#" class="gallery-item" data-gallery-item>
            <img src="<?php echo e(asset('assets/img/sr-1-2.jpg')); ?>" alt="Doctor consulting with a patient" class="gallery-item__img aspect-[4/5]" />
            <span class="gallery-item__overlay">
              <span class="gallery-item__expand">
                <svg width="30" height="30" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M15 4h5v5M9 20H4v-5M20 4l-6 6M4 20l6-6" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
          ...
          <a href="#" class="gallery-item" data-gallery-item>
            <img src="<?php echo e(asset('assets/img/slider-1.3.jpg')); ?>" alt="Medical team on duty" class="gallery-item__img aspect-[16/11]" />
            <span class="gallery-item__overlay">
              <span class="gallery-item__expand">
                <svg width="30" height="30" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M15 4h5v5M9 20H4v-5M20 4l-6 6M4 20l6-6" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
          ...
          <a href="#" class="gallery-item" data-gallery-item>
            <img src="<?php echo e(asset('assets/img/projects-3.jpg')); ?>" alt="Cardiology department" class="gallery-item__img aspect-[3/4]" />
            <span class="gallery-item__overlay">
              <span class="gallery-item__expand">
                <svg width="30" height="30" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M15 4h5v5M9 20H4v-5M20 4l-6 6M4 20l6-6" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
          ...
          <a href="#" class="gallery-item" data-gallery-item>
            <img src="<?php echo e(asset('assets/img/sr-1-3.jpg')); ?>" alt="Doctor in the medical library" class="gallery-item__img aspect-square" />
            <span class="gallery-item__overlay">
              <span class="gallery-item__expand">
                <svg width="30" height="30" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M15 4h5v5M9 20H4v-5M20 4l-6 6M4 20l6-6" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
          ...
          <a href="#" class="gallery-item" data-gallery-item>
            <img src="<?php echo e(asset('assets/img/projects-4.jpg')); ?>" alt="Surgery preparation room" class="gallery-item__img aspect-[4/3]" />
            <span class="gallery-item__overlay">
              <span class="gallery-item__expand">
                <svg width="30" height="30" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M15 4h5v5M9 20H4v-5M20 4l-6 6M4 20l6-6" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
          ...
          <a href="#" class="gallery-item" data-gallery-item>
            <img src="<?php echo e(asset('assets/img/appoinment.jpg')); ?>" alt="Reception and appointment desk" class="gallery-item__img aspect-[4/5]" />
            <span class="gallery-item__overlay">
              <span class="gallery-item__expand">
                <svg width="30" height="30" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M15 4h5v5M9 20H4v-5M20 4l-6 6M4 20l6-6" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
...
<?php echo $__env->make('layouts.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon-new\laragon\www\hospital-management\resources\views\frontend\gallery.blade.php ENDPATH**/ ?>