...
<?php if(!empty($mgmt['mgmt_seo_keywords'])): ?>
<?php $__env->startSection('meta_keywords', $mgmt['mgmt_seo_keywords']); ?>
<?php endif; ?>
<?php if(!empty($mgmt['mgmt_seo_og_image'])): ?>
<?php $__env->startSection('og_image', asset('storage/' . $mgmt['mgmt_seo_og_image'])); ?>
<?php endif; ?>
    ...
    <section class="page-header">
      ...
      <div class="page-header__inner">
        ...
        <nav class="page-header__breadcrumb" aria-label="Breadcrumb">
          ...
          <span><?php echo e(__('frontend.breadcrumb.management')); ?></span>
        </nav>
      </div>
      ...
      <div class="container mx-auto">
        <div class="team__head">
          <p class="team__eyebrow">
            ...
            <?php echo e($mgmt['mgmt_badge'] ?? 'Our Leadership'); ?>

            <span class="team__eyebrow-dot"></span>
          </p>
          <h2 class="team__title"><?php echo e($mgmt['mgmt_title'] ?? 'Meet Our Management Team'); ?></h2>
        </div>

        <div class="management__grid">
          <?php $__currentLoopData = $mgmtCards; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $card): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <article class="mgmt-card">
            <div class="mgmt-card__photo-wrap">
              <img src="<?php echo e($card['photo']); ?>" alt="<?php echo e($card['name']); ?><?php echo e($card['role'] ? ', ' . $card['role'] : ''); ?>" class="mgmt-card__photo" />
            </div>

            <div class="mgmt-card__bar">
              <div>
                <h3 class="mgmt-card__name"><?php echo e($card['name']); ?></h3>
                <p class="mgmt-card__role"><?php echo e($card['role']); ?></p>
              </div>
              <a href="<?php echo e(route('management')); ?>" class="mgmt-card__arrow" aria-label="View <?php echo e($card['name']); ?>">
            ...
            <div class="mgmt-card__social">
              <?php $__currentLoopData = ['linkedin' => 'LinkedIn', 'facebook' => 'Facebook', 'twitter' => 'Twitter', 'instagram' => 'Instagram', 'youtube' => 'YouTube']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <a href="<?php echo e($card[$key] ?: '#'); ?>" class="mgmt-card__social-link" aria-label="<?php echo e($label); ?>">
                <?php echo $mgmtSocialIcons[$key]; ?>
