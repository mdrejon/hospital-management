      ...
      <div class="hero__viewport">
        <div class="hero__track" data-hero-track>
          ...
          <div class="hero-slide">
            <img src="<?php echo e(asset('assets/img/slider-1.2.jpg')); ?>" alt="Doctor examining a baby patient" class="hero-slide__bg" />
            ...
            <div class="hero-slide__inner">
              <div class="hero-slide__content" data-hero-content>
                ...
                <a href="<?php echo e(route('appointment')); ?>" class="hero-slide__cta">
                  Make Appointment
          ...
          <!-- Slide 2 -->
          <div class="hero-slide">
            <img src="<?php echo e(asset('assets/img/slider-1.3.jpg')); ?>" alt="Medical team performing a procedure on a patient" class="hero-slide__bg" />
            <span class="hero-slide__overlay"></span>
                ...
                <article class="department-card">
                  ...
                  <div class="department-card__media">
                    <div class="department-card__badge">
                      ...
                      <a href="<?php echo e(route('service-details')); ?>" class="department-card__arrow" aria-label="View Haematology">
                        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path d="M5 12h14M13 6l6 6-6 6" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
                      </a>
                    </div>
                    <img src="<?php echo e(asset('assets/img/slider-1.3.jpg')); ?>" alt="Medical team performing a procedure" class="department-card__img" />
                  </div>
                </article>
              </div>
                ...
                <article class="department-card is-alt">
                  ...
                  <div class="department-card__media">
                    <div class="department-card__badge">
                      ...
                      <a href="<?php echo e(route('service-details')); ?>" class="department-card__arrow" aria-label="View Pediatrician">
                        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path d="M5 12h14M13 6l6 6-6 6" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
                      </a>
                    </div>
                    <img src="<?php echo e(asset('assets/img/slider-1.2.jpg')); ?>" alt="Doctor examining a baby patient" class="department-card__img" />
                  </div>
                </article>
              </div>
                ...
                <article class="department-card">
                  ...
                  <div class="department-card__media">
                    <div class="department-card__badge">
                      ...
                      <a href="<?php echo e(route('service-details')); ?>" class="department-card__arrow" aria-label="View Cardiologist">
                        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path d="M5 12h14M13 6l6 6-6 6" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
                      </a>
                    </div>
                    <img src="<?php echo e(asset('assets/img/about-image.webp')); ?>" alt="Doctor with a stethoscope" class="department-card__img" />
                  </div>
                </article>
              </div>
            </div>
            ...
            <div class="team__track" data-team-track>
              ...
              <div class="team__slide">
                <article class="team-card">
                  ...
                  <div class="team-card__photo-wrap">
                    <img src="<?php echo e(asset('assets/img/team-3.png')); ?>" alt="Dr. Laron Metar" class="team-card__photo" />
                    <span class="team-card__overlay">
                      <a href="<?php echo e(route('doctor-details')); ?>" class="team-card__view" aria-label="View Dr. Laron Metar profile">
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path d="m10 6 6 6-6 6" stroke="currentColor" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
                      </a>
              ...
              <div class="team__slide">
                <article class="team-card">
                  ...
                  <div class="team-card__photo-wrap">
                    <img src="<?php echo e(asset('assets/img/team-3.png')); ?>" alt="Dr. Smith Karo" class="team-card__photo" />
                    <span class="team-card__overlay">
                      <a href="<?php echo e(route('doctor-details')); ?>" class="team-card__view" aria-label="View Dr. Smith Karo profile">
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path d="m10 6 6 6-6 6" stroke="currentColor" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
                      </a>
              ...
              <div class="team__slide">
                <article class="team-card">
                  ...
                  <div class="team-card__photo-wrap">
                    <img src="<?php echo e(asset('assets/img/team-3.png')); ?>" alt="Dr. Merata Baron" class="team-card__photo" />
                    <span class="team-card__overlay">
                      <a href="<?php echo e(route('doctor-details')); ?>" class="team-card__view" aria-label="View Dr. Merata Baron profile">
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path d="m10 6 6 6-6 6" stroke="currentColor" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
                      </a>
              ...
              <div class="team__slide">
                <article class="team-card">
                  ...
                  <div class="team-card__photo-wrap">
                    <img src="<?php echo e(asset('assets/img/team-3.png')); ?>" alt="Dr. Elena Cross" class="team-card__photo" />
                    <span class="team-card__overlay">
                      <a href="<?php echo e(route('doctor-details')); ?>" class="team-card__view" aria-label="View Dr. Elena Cross profile">
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path d="m10 6 6 6-6 6" stroke="currentColor" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
                      </a>
              ...
              <div class="team__slide">
                <article class="team-card">
                  ...
                  <div class="team-card__photo-wrap">
                    <img src="<?php echo e(asset('assets/img/team-3.png')); ?>" alt="Dr. Michael Reyes" class="team-card__photo" />
                    <span class="team-card__overlay">
                      <a href="<?php echo e(route('doctor-details')); ?>" class="team-card__view" aria-label="View Dr. Michael Reyes profile">
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path d="m10 6 6 6-6 6" stroke="currentColor" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
                      </a>
              ...
              <div class="team__slide">
                <article class="team-card">
                  ...
                  <div class="team-card__photo-wrap">
                    <img src="<?php echo e(asset('assets/img/team-3.png')); ?>" alt="Dr. Sara Owens" class="team-card__photo" />
                    <span class="team-card__overlay">
                      <a href="<?php echo e(route('doctor-details')); ?>" class="team-card__view" aria-label="View Dr. Sara Owens profile">
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path d="m10 6 6 6-6 6" stroke="currentColor" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
                      </a>
          ...
          <div class="packages__track" data-packages-track>
            ...
            <div class="packages__slide">
              <article class="package-card group">
                <img src="<?php echo e(asset('assets/img/sr-1-2.jpg')); ?>" alt="Doctor consulting with a patient" class="package-card__img" />
                <span class="package-card__overlay"></span>
                <a href="<?php echo e(route('services')); ?>" class="package-card__plus" aria-label="View Full Body Checkup package">
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M12 5v14M5 12h14" stroke="currentColor" stroke-width="2.4" stroke-linecap="round"/>
                  </svg>
                </a>
            ...
            <div class="packages__slide">
              <article class="package-card group">
                <img src="<?php echo e(asset('assets/img/sr-1-3.jpg')); ?>" alt="Dermatology treatment session" class="package-card__img" />
                <span class="package-card__overlay"></span>
                <a href="<?php echo e(route('services')); ?>" class="package-card__plus" aria-label="View Dermatology and Wellness package">
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M12 5v14M5 12h14" stroke="currentColor" stroke-width="2.4" stroke-linecap="round"/>
                  </svg>
                </a>
            ...
            <div class="packages__slide">
              <article class="package-card group">
                <img src="<?php echo e(asset('assets/img/about-image.webp')); ?>" alt="Doctor with a stethoscope" class="package-card__img" />
                <span class="package-card__overlay"></span>
                <a href="<?php echo e(route('services')); ?>" class="package-card__plus" aria-label="View Cardiac Care package">
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M12 5v14M5 12h14" stroke="currentColor" stroke-width="2.4" stroke-linecap="round"/>
                  </svg>
                </a>
            ...
            <div class="packages__slide">
              <article class="package-card group">
                <img src="<?php echo e(asset('assets/img/slider-1.2.jpg')); ?>" alt="Doctor examining a baby patient" class="package-card__img" />
                <span class="package-card__overlay"></span>
                <a href="<?php echo e(route('services')); ?>" class="package-card__plus" aria-label="View Pediatric Care package">
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M12 5v14M5 12h14" stroke="currentColor" stroke-width="2.4" stroke-linecap="round"/>
                  </svg>
                </a>
            ...
            <div class="packages__slide">
              <article class="package-card group">
                <img src="<?php echo e(asset('assets/img/sr-1-1.jpg')); ?>" alt="Surgical team performing a procedure" class="package-card__img" />
                <span class="package-card__overlay"></span>
                <a href="<?php echo e(route('services')); ?>" class="package-card__plus" aria-label="View Surgical Care package">
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M12 5v14M5 12h14" stroke="currentColor" stroke-width="2.4" stroke-linecap="round"/>
                  </svg>
                </a>
            ...
            <div class="packages__slide">
              <article class="package-card group">
                <img src="<?php echo e(asset('assets/img/slider-1.3.jpg')); ?>" alt="Medical team performing an emergency procedure" class="package-card__img" />
                <span class="package-card__overlay"></span>
                <a href="<?php echo e(route('services')); ?>" class="package-card__plus" aria-label="View Emergency Response package">
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M12 5v14M5 12h14" stroke="currentColor" stroke-width="2.4" stroke-linecap="round"/>
                  </svg>
                </a>
      ...
      <div class="container mx-auto">
        ...
        <div class="blog__grid">
          ...
          <article class="blog-card blog-card--split is-tall">
            <img src="<?php echo e(asset('assets/img/blog-one.png')); ?>" alt="Nurse holding a stethoscope" class="blog-card__img" />
            ...
            <a href="<?php echo e(route('blog-details')); ?>" class="blog-card--split__cta">
              Read More
          ...
          <article class="blog-card blog-card--photo is-tall">
            <img src="<?php echo e(asset('assets/img/blog-2.png')); ?>" alt="Doctor speaking with a patient" class="blog-card__img" style="object-position: 50% 20%;" />
            ...
            <div class="blog-card--photo__footer">
              ...
              <a href="<?php echo e(route('blog-details')); ?>" class="blog-card__arrow" aria-label="Read more">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M7 17 17 7M9 7h8v8" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
              </a>
          ...
          <article class="blog-card blog-card--photo">
            <img src="<?php echo e(asset('assets/img/blog-4.jpg')); ?>" alt="Doctor checking a patient's blood pressure" class="blog-card__img" />
            <span class="blog-card__overlay"></span>
            <span class="blog-card__date relative z-10 w-fit"><span class="blog-card__date-dot"></span>July 9, 2025</span>
            <div class="blog-card--photo__footer">
      ...
      <div class="container relative mx-auto">
        ...
        <div class="book-appointment__card">
          ...
          <div class="book-appointment__media">
            <img src="<?php echo e(asset('assets/img/appoinment-img.jpg')); ?>" alt="Nurse assisting an elderly patient from a wheelchair" class="book-appointment__img" />
          </div>
        </div>
      </div>
    </section>
