  ...
  <aside class="side-panel" data-side-panel>
    ...
    <p class="side-panel__desc">
      <?php echo e($headerSettings['header_sidebar_description'] ?? "We are committed to providing compassionate, high-quality healthcare services to our patients and community. Your health is our priority."); ?>
    ...
    <nav class="side-panel__nav">
      ...
      <a href="<?php echo e(route('services')); ?>" class="side-panel__nav-link"><?php echo e(__('frontend.nav.our_service')); ?></a>
      <a href="<?php echo e(route('packages')); ?>" class="side-panel__nav-link">Packages</a>
      ...
      <div>
        ...
        <div class="side-panel__submenu">
          <a href="<?php echo e(route('gallery')); ?>" class="side-panel__nav-sublink">Photo Gallery</a>
          <a href="<?php echo e(route('video-gallery')); ?>" class="side-panel__nav-sublink">Video Gallery</a>
        </div>
      </div>
      ...
      <a href="<?php echo e(route('login')); ?>" class="side-panel__nav-link" style="color: #2563eb; font-weight: 700;">🔑 Agent Login / Portal</a>
    </nav>
  ...
  </aside><?php /**PATH D:\laragon-new\laragon\www\hospital-management\resources\views/components/frontend/header.blade.php ENDPATH**/ ?>